  ...
  try {
    {
      ...
      if (offerJSON && Object.keys(offerJSON).length > 0 && offerJSON != null) {
        ...
        //Remove the offerid json from cache
        await state.delete(offerId)


      }
      // Removed as we need to remove unpublished offer from cache
